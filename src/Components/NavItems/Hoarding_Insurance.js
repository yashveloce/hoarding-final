...
mutation MyMutation($from_date: date = "2021-11-16", $insurance: String = "", $inventory: Int = 0, $to_date: date = "2021-11-16") {
...
mutation MyMutation($from_date: date = "2021-11-16", $insurance: String = "", $inventory: Int = 0, $to_date: date = "2021-11-16", $id: Int = 0) {
...
function Hoarding_Insurance() {
    ...
    const [getInventory,getInventoryData] = useLazyQuery(GET_INVENTORY,{
        onCompleted: data => {
    ...
    const onInventoryChange = (e) => {
        ...
        getInventory({variables:{id:e.target.value}})
        console.log(get_data.Inventory_Master_by_pk.hoarding_insurance)
    }
                ...
                <form onSubmit={onFormSubmit} className='form-group'>
                    <div className="col-md-12">
                        ...
                        <div className="row mt-3">
                            <div className="field col-md-4 ">
                                <label className="required">Hoarding Insurance</label>
                                <select defaultValue={get_data===undefined?"":get_data.Inventory_Master_by_pk.hoarding_insurance} className="form-control mt-2" onChange={onInsuranceChange} >
                                    <option>Select...</option>
                                    <option>Yes</option>
                                    <option>No</option>
                                </select>
